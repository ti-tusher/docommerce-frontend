...
@section('canonical')
    <link rel="canonical" href="{{ route('store-management') }}" />
@endsection
                ...
                <div class="col-xxl-5 col-xl-6 col-lg-8">
                    <div class="hero__content-2 about__wrapper mt-55">
                        <h2 class="hero__title-2">
                            বিভিন্ন স্টোরের প্রোডাক্ট<br>
                            বিক্রির তথ্য স্বয়ংক্রিয়ভাবে<br>
                            আপডেট হয়ে যায়
                        </h2>
                        <p>
                            ই-কমার্স ওয়েবসাইট, মোবাইল অ্যাপ, ফেইসবুক, ইনস্টাগ্রাম এবং শোরুমের পিওএস, যেখানেই সেল করুন না কেন, প্রোডাক্ট বিক্রির তথ্য স্বয়ংক্রিয়ভাবে সমস্ত প্ল্যাটফর্মে আপডেট হয়ে যাবে।
                        </p>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-9">
                    <div class="about__wrapper about__wrapper-2 ml-60 mb-30">
                        <div class="section__title-wrapper mb-25">
                            <h2 class="section__title">যে কোন স্টোর ম্যানেজ হবে একটি ড্যাশবোর্ড থেকেই</h2>
                            <p>
                                আপনার অনলাইন স্টোর ম্যানেজ করুন ডু-কমার্সের একটি ড্যাশবোর্ড থেকেই! ই-কমার্স অথবা সোশ্যাল মিডিয়ার যে কোনো স্টোরের প্রায় সব কিছু ম্যানেজ করতে স্টোর ড্যাশবোর্ড বা মোবাইল অ্যাপের সাহায্য নিন।
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="about__wrapper mb-10">
                        <div class="section__title-wrapper mb-25">
                            <h2 class="section__title">
                                ডেলিভারি ম্যানেজ হবে, এক ক্লিকে!
                            </h2>
                            <p>
                                ডেলিভারি প্যাকেজ আপডেট কিংবা রেইট আপডেট করতে ডেলিভারি মডিউল থেকে সহজেই পুনঃনির্ধারিত প্যাকেজ অ্যাক্টিভেট করুন।
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-9">
                    <div class="about__wrapper about__wrapper-2 ml-60 mb-30">
                        <div class="section__title-wrapper mb-25">
                            <h2 class="section__title">
                                সমস্ত লেনদেন হবে সহজে এবং দ্রুত
                            </h2>
                            <p>
                                যে কোনো ধরণের ইলেক্ট্রনিক পেমেন্ট গ্রহণ করতে ডু-কমার্সের ইন্টিগ্রেটেড পেমেন্ট গেটওয়ে ব্যবহার করুন। ব্যাংক কার্ড কিংবা মোবাইল ওয়ালেট, সব ধরণের ইলেক্ট্রনিক পেমেন্ট সল্যুশনের সুবিধা নিন।
                            </p>
                        </div>
                    </div>
                </div>
